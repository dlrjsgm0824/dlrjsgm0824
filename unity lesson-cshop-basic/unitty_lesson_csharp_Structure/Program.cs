...
// 변수들을 여러가지 써야되는데 해당 변수들의 집합을 사용한곳이 많거나 
// 변수 집합읭 요소가 너무 많아,묶어서 따로 분리해야 가독성과 관리가 편할 것 같을 때
// 구조체의 구조는 클래스에서 함수가 빠진 것과 같다.
namespace unitty_lesson_csharp_Structure
{
    class Program
    {
